...
import com.ryg.chapter_2.demo4.BuildConfig;
import com.ryg.chapter_2.demo4.mvp.model.api.Api;
 ...
 * Created by MVPArmsTemplate on 06/24/2019 09:31
...
//    public static String sDomain = Api.APP_DOMAIN;
    ...
    public void applyOptions(Context context, GlobalConfigModule.Builder builder) {
        ...
        builder.baseurl(Api.APP_DOMAIN)
                ...
                .imageLoaderStrategy(new BitmapImageLoaderStrategy())
