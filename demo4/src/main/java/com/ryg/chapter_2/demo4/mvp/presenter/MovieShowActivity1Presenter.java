 ...
 */
@ActivityScope
public class MovieShowActivity1Presenter extends BasePresenter<MovieShowActivity1Contract.Model, MovieShowActivity1Contract.View> {
    @Inject
    ...
    @Inject
    public MovieShowActivity1Presenter(MovieShowActivity1Contract.Model model, MovieShowActivity1Contract.View rootView) {
